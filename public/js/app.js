...
window.app = new (vue_dist_vue_js__WEBPACK_IMPORTED_MODULE_0___default())({
  el: '#app',
  data: {
    servers: [],
    filters: {
      options: {
        storage: [0, 250, 500, 1000, 2000, 3000, 4000, 8000, 12000, 24000, 48000, 72000],
        //In Gigabytes
  ...
  computed: {
    filteredServers: function filteredServers() {
      var instance = this; //Text filter:

      var servers = this.servers.filter(function (s) {
      ...
      servers = servers.filter(function (s) {
        var storage = parseInt(instance.filters.selected.storage);
  ...
  methods: {
    ...
    showComparisonModal: function showComparisonModal() {
